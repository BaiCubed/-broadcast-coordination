...
class CQRPredictor:
    ...
    def __init__(
        ...
        self._pos_cqr_scores: List[float] = []
        self._neg_cqr_scores: List[float] = []
        ...
        self._aci_gamma: float = 0.005
        self._aci_min_alpha: float = 0.03
        self._aci_max_alpha: float = 0.20
        self._aci_warmup: int = 20
...
class CoverageTracker:
    ...
    def __init__(self, window_size: int = 100):
        ...
        self._records: List[Tuple[float, bool, float]] = []
